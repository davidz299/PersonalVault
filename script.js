...
const WeatherSnap = () => {
    const [temperature] = React.useState(N.rand(3, 8));
...
const Weather = () => {
    const getDays = () => {
        return [{
                ...
                id: 3,
                name: "Wed",
                temperature: N.rand(5, 10),
                weather: WeatherType.Cloudy
            }, {
                id: 4,
                name: "Thurs",
                temperature: N.rand(5, 15),
...
const Movies = () => {
    const getMovies = () => {
        return [{
                ...
                desc: "The jungle of anchient wooden houses in the Amazon Rainforest.",
                id: 2,
                ...
                title: "Ancient Houses"
            }, {
                desc: "A boy with a dream of becoming a superhero discovers new talents to save the world.",
                id: 3,
                ...
                desc: "A long drawn out story of some people owning land in the middle of North Dakota.",
                id: 4,
